...
# Membaca data 
data = pd.read_csv('database ukt 2023 fix.csv', delimiter=',', encoding='latin-1')
...
data['fakultas'] = data['jurusan'].apply(map_to_fakultas)
...
# Simpan data
selected_data.to_csv('databaseUkt2023_preprocessed3.csv', index=False)

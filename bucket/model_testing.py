...
misclassified_data = pd.DataFrame(X_test, columns=data.drop(columns=['ukt_rev', 'no_test']).columns)
misclassified_data['true_label'] = y_test
misclassified_data['predicted_label'] = y_pred_test
misclassified_data = misclassified_data[misclassified_data['true_label'] != misclassified_data['predicted_label']]
misclassified_data_targeted = misclassified_data[((misclassified_data['true_label'] == 2) & (misclassified_data['predicted_label'] != 2))]
misclassified_data_targeted.to_csv('misclassified_data_targeted.csv', index=False)
